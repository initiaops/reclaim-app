      ...
      <div className="max-w-3xl mx-auto px-4 py-16 space-y-20">
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                body: 'Capacity patterns shift as projects start and end. Run a new audit each month to track your admin tax trend over time. Free users get 1 audit per month. Pro members get unlimited audits plus a weekly ops brief every Monday.',
                tag: null,
              },
        ...
        <section id="plans">
          ...
          <p className="text-gray-500 text-sm mb-8">
            All plans include the full audit experience. Pro unlocks unlimited audits, history, and a weekly ops brief.
          </p>
          ...
          <div className="overflow-x-auto rounded-2xl border border-gray-200">
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  { feature: 'Capacity audits per month',        free: '1',            pro: 'Unlimited'    },
                  { feature: 'All 7 audit outputs',              free: true,           pro: true           },
                  { feature: 'AI confidence score',              free: true,           pro: true           },
                  { feature: 'Copy ops brief to clipboard',      free: true,           pro: true           },
                  { feature: 'Google Calendar connection',       free: true,           pro: true           },
                  { feature: 'Calendar Insights panel',          free: true,           pro: true           },
                  { feature: 'Admin tax from real calendar data',free: true,           pro: true           },
                  { feature: 'Meeting category breakdown',       free: true,           pro: true           },
                  { feature: 'Weekly ops brief (every Monday)',  free: false,          pro: true           },
                  { feature: 'Audit history',                    free: 'Session only', pro: 'Full history' },
                  { feature: 'Priority support',                 free: false,          pro: true           },
                  { feature: 'Price',                            free: 'Free forever', pro: '$29/month'    },
        ...
        <section>
          ...
          <div className="space-y-5">
            {[
              ...
              { q: 'How do I upgrade to Pro?', a: 'Go to your billing page and click "Upgrade to Pro". You\'ll be taken to a Stripe checkout page. Once payment is confirmed, your account is immediately upgraded to unlimited audits and the weekly brief starts the following Monday.' },
